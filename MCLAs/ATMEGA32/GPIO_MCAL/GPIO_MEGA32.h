...
* 1. GPIOx             >>>  @ref (GPIOA-GPIOB-GPIOC-GPIOD)
* 2. pin_number        >>>  according to MACROs @ref (_PIN0 ~ _PIN7 - ALL_PINS)
* 3. port_mode         >>>  according to MACROs @ref (PINs_MODES_MACROs)
* 
* it returns nothing !
...
* 1. GPIOx             >>>  @ref(GPIOA-GPIOB-GPIOC-GPIOD)
* 2. pin_number        >>>  according to MACROs @ref (_PIN0 ~ _PIN7)
* it returns nothing !
*/
